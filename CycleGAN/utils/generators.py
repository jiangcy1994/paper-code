...
__all__ = ['autoencoder', 'unet', 'resnet_6blocks', 'resnet_9blocks']
...
def resnet_6blocks(img_shape, ngf, name=None):
    ...
    layers = compose(
        ...
        build_res_block(ngf * 4, 'reflect', name=name +
                        'res_block1' if name else None),
        build_res_block(ngf * 4, 'reflect', name=name +
                        'res_block2' if name else None),
        build_res_block(ngf * 4, 'reflect', name=name +
                        'res_block3' if name else None),
        build_res_block(ngf * 4, 'reflect', name=name +
                        'res_block4' if name else None),
        build_res_block(ngf * 4, 'reflect', name=name +
                        'res_block5' if name else None),
        build_res_block(ngf * 4, 'reflect', name=name +
                        'res_block6' if name else None),
...
def resnet_9blocks(img_shape, ngf, name=None):
    ...
    layers = compose(
        ...
        build_res_block(ngf * 4, 'reflect', name=name +
                        'res_block6' if name else None),
        build_res_block(ngf * 4, 'reflect', name=name +
                        'res_block7' if name else None),
        build_res_block(ngf * 4, 'reflect', name=name +
                        'res_block8' if name else None),
        build_res_block(ngf * 4, 'reflect', name=name +
                        'res_block9' if name else None),
